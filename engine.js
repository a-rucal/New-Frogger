...
var TitleScreen = function TitleScreen(title,subtitle,callback) {
  ...
  this.draw = function(ctx) {
    ...
    var imgFrogger = new Image(263, 167);
    imgFrogger.src = 'images/sprites.png';

    ctx.drawImage(imgFrogger, 7, 395, 263, 167, 150, 150, 263, 167);
    ctx.fillStyle = "#FFFFFF";
    ctx.textAlign = "center";
...
var GameBoard = function() {
  ...
  // Add a new object at the end of the object list
